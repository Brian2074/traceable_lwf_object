...
def args_parser():
    ...
    parser.add_argument('--num_clients', type=int, default=2, help='initial number of clients')
    ...
    # Local tasks
    parser.add_argument('--batch_size', type=int, default=16, help='size of mini-batch')
